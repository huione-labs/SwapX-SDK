...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@swapx/sdk-core'
...
import ISwapRouter from '@swapx/v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
