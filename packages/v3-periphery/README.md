...
`@swapx/v3-periphery/artifacts/contracts/*/*.json`.
For example:
...
} from '@swapx/v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
...
via the npm artifact `@swapx/v3-periphery`, e.g.:

```solidity
import '@swapx/v3-periphery/contracts/interfaces/ISwapRouter.sol';
